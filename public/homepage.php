...
<main class="container-fluid mt-lg-5 pt-2">
    ...
    <section class="row my-4 justify-content-center ">
        <article class="borda_post shadow col-11">
            <div class="row mt-1">
                <div class="col-2 col-md-2 col-lg-1 my-auto">
                    <img src="images/11.jpg" class="img-fluid rounded-circle p-sm-1">
                </div>
                <div class="col-8 col-sm-8 position-relative">
                    <h4 class="pt-3">Leonel Catalano</h4>
                    <p>Tribo de Anime * 12/05/2021</p>
                </div>
                <div class="col-2 col-lg-3 text-right my-auto">
                    <div class="dropdown show">
                        <div class="btn-group dropleft">
            ...
            <div class="pt-2">
                <p>!! SPOILER ALERT !!</p>
                <p>Vocês nem vão acreditar no que acabei de descobrir em Attack On Titan! A MIKASA VAI MATAR O EREN!
                    Este anime está cada vez melhor! Classificação 10/10!
                <div class="float-right pb-2">
                    <i class="fas fa-plus-circle fa-2x" data-target="#myModal2" data-toggle="modal"></i>
                </div>
            </div>
