...
<main class="container-fluid container-md background">
    ...
    <section class="justify-content-center mt-5 row">
        <p class="col-11 text-center font-weight-bold">Gostas de skatar? Anda daí partilhar os teus truques, aprender
            uns
            novos e conhecer malta fixe. Esta é a tua
            tribo!</p>
    </section>
